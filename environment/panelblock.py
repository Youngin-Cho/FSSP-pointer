...
if __name__ == "__main__":
    ...
    write_block_date(file_dir, num_of_process=6, num_of_blocks=25, case=30, distribution="lognormal")
    write_block_date(file_dir, num_of_process=6, num_of_blocks=50, case=30, distribution="lognormal")
